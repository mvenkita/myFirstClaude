...
// include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmp2em4hbob.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'webgpu_prover.data';
      var REMOTE_PACKAGE_BASE = 'webgpu_prover.data';
...
Module['FS_createPath']("/", "shader", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_webgpu_prover.data');

      };
      Module['addRunDependency']('datafile_webgpu_prover.data');
    ...
    loadPackage({"files": [{"filename": "/modules/custom.wasm", "start": 0, "end": 735}, {"filename": "/shader/bignum.wgsl", "start": 735, "end": 34132}, {"filename": "/shader/sha256.wgsl", "start": 34132, "end": 41112}], "remote_package_size": 41112});

  })();

// end include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmp2em4hbob.js
// include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmpa19_mbj5.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmpa19_mbj5.js
// include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmp3fv186q2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/2p/cs8nfx8d68bbv5zjtbvgq37m0000gp/T/tmp3fv186q2.js
...
// end include: preamble.js
  ...
  function _wgpuCommandEncoderClearBuffer(encoderId,bufferId,offset_low, offset_high,size_low, size_high) {
    var offset = convertI32PairToI53Checked(offset_low, offset_high);
...
var _wgpuRequestAdapterSync = Module['_wgpuRequestAdapterSync'] = createExportWrapper('wgpuRequestAdapterSync', 1);
var _wgpuRequestDeviceSync = Module['_wgpuRequestDeviceSync'] = createExportWrapper('wgpuRequestDeviceSync', 2);
var _wgpuBufferMapSync = Module['_wgpuBufferMapSync'] = createExportWrapper('wgpuBufferMapSync', 4);
var _wgpuDeviceSynchronize = Module['_wgpuDeviceSynchronize'] = createExportWrapper('wgpuDeviceSynchronize', 2);
var __ZN5boost13serialization16singleton_module8get_lockEv = Module['__ZN5boost13serialization16singleton_module8get_lockEv'] = createExportWrapper('_ZN5boost13serialization16singleton_module8get_lockEv', 1);
...
var __ZNK5boost7archive6detail11oserializerINS0_15binary_oarchiveENSt3__26vectorIjNS4_9allocatorIjEEEEE16save_object_dataERNS1_14basic_oarchiveEPKv = Module['__ZNK5boost7archive6detail11oserializerINS0_15binary_oarchiveENSt3__26vectorIjNS4_9allocatorIjEEEEE16save_object_dataERNS1_14basic_oarchiveEPKv'] = createExportWrapper('_ZNK5boost7archive6detail11oserializerINS0_15binary_oarchiveENSt3__26vectorIjNS4_9allocatorIjEEEEE16save_object_dataERNS1_14basic_oarchiveEPKv', 3);
...
var dynCall_iiiijjj = Module['dynCall_iiiijjj'] = createExportWrapper('dynCall_iiiijjj', 10);
