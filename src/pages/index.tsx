      ...
      <div className="space-y-4">
        ...
        {encoding.length > 0 && (
          <div className="space-y-2">
            ...
            <p className="font-semibold">For all the tests in Stage 2, prover includes the coefficients in the proof rather than the encoding. The verifier can recompute both the secrets and encoding by re-evaluating the polynomial</p>
          </div>
        )}
      </CardContent>
      </Card>
